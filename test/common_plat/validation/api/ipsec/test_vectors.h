...
KEY(key_rfc3602,
    0x90, 0xd3, 0x82, 0xb4, 0x10, 0xee, 0xba, 0x7a,
...
KEY(key_mcgrew_gcm_2,
    0xfe, 0xff, 0xe9, 0x92, 0x86, 0x65, 0x73, 0x1c,
    0x6d, 0x6a, 0x8f, 0x94, 0x67, 0x30, 0x83, 0x08);

KEY(key_mcgrew_gcm_salt_2,
    0xca, 0xfe, 0xba, 0xbe);

KEY(key_mcgrew_gcm_3,
    0xab, 0xbc, 0xcd, 0xde, 0xf0, 0x01, 0x12, 0x23,
    0x34, 0x45, 0x56, 0x67, 0x78, 0x89, 0x9a, 0xab,
    0xab, 0xbc, 0xcd, 0xde, 0xf0, 0x01, 0x12, 0x23,
    0x34, 0x45, 0x56, 0x67, 0x78, 0x89, 0x9a, 0xab);

KEY(key_mcgrew_gcm_salt_3,
    0x11, 0x22, 0x33, 0x44);

KEY(key_mcgrew_gcm_4,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);

KEY(key_mcgrew_gcm_salt_4,
    0x00, 0x00, 0x00, 0x00);

KEY(key_mcgrew_gcm_12,
    0x7d, 0x77, 0x3d, 0x00, 0xc1, 0x44, 0xc5, 0x25,
    0xac, 0x61, 0x9d, 0x18, 0xc8, 0x4a, 0x3f, 0x47);

KEY(key_mcgrew_gcm_salt_12,
    0xd9, 0x66, 0x42, 0x67);
